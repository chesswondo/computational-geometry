...
#define __BGI_GRAPHICS_H__
  ...
  #ifdef _WIN64
    #pragma comment(lib, "openbgi64.lib")
  #else
    #pragma comment(lib, "openbgi32.lib")
  #endif
...
#define LIGHTGREEN (_getabsolutecolor(_LIGHTGREEN))
#define LIGHTCYAN (_getabsolutecolor(_LIGHTCYAN))
#define LIGHTRED (_getabsolutecolor(_LIGHTRED))
#define LIGHTMAGENTA (_getabsolutecolor(_LIGHTMAGENTA))
